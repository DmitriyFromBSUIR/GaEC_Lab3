...
#from Experiments.QtTextEditor import QtWidgets, MyApp, QtGui

#add current project path to the python session's sys.path
...
if __name__ == "__main__":
    ...
    app.setApplicationName("Qt Text Editor Test App v1.0")
    window = MyApp()
    window.show()
    sys.exit(app.exec_())
